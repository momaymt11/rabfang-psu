...
function Provider_visits_appointments() {
  ...
  useEffect(() => {
    axios
      .post(URL + "/rabfang_api/psy/psy_visits_appointments", {
        psy_id: psy_id,
      })
  ...
  const go_talk_page = (a_id) => {
    navigate("/provider_talk_page/" + a_id);
  };
  return (
    <Container
      fluid
                  ...
                  <Container>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-7">
                        <CardText tag="h5">{item["u_name"]}</CardText>
                        <CardText tag="h6">
                          {item["u_faculty"]}, {item["u_major"]}
                        </CardText>
...
export default Provider_visits_appointments;
